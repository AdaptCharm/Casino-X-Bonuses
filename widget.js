...
(function($) {
  ...
  ArContactUs.prototype._appendMessengerIcons = function($container) {
    $.each(this.settings.items, function(i) {
      ...
      var $icon = $('<span>', {
        style: (this.color ? ('background:' + this.color) : null)
      });
      ...
      success: function(data) {
        ...
        if (data.success) {
          ...
          if (data.errors) {
            ...
            notify($this.settings.errorMessage);
          }
        }
  ...
  ArContactUs.prototype._backgroundStyle = function() {
    return 'background: ' + this.settings.theme;
  };
  ArContactUs.prototype._colorStyle = function() {
    return 'color: ' + this.settings.themeColor;
  };
